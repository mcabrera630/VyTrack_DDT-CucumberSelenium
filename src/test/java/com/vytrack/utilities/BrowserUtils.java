...
public class BrowserUtils {
    ...
    public static void clickWithWait(By by, int attempts) {
        ...
        while (counter < attempts) {
            try {
                ...
                clickWithJS(ConfigurationReader.Driver.get().findElement(by));
    ...
    public static void waitForPresenceOfElement(By by, long time) {
        new WebDriverWait(ConfigurationReader.Driver.get(), time).until(ExpectedConditions.presenceOfElementLocated(by));
    }
